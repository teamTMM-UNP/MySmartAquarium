...
public class AddAttributeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uniparthenope.mysmartaquarium.R.layout.activity_add_attribute);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Toolbar toolbar = (Toolbar) findViewById(com.uniparthenope.mysmartaquarium.R.id.toolbar_add_attribute);
        toolbar.setTitle("");
    ...
    void init() {
        attributeTypes = (Spinner) findViewById(com.uniparthenope.mysmartaquarium.R.id.spinnerAttributes);
        attributeData = (EditText) findViewById(com.uniparthenope.mysmartaquarium.R.id.editTextAttrData);
        addAttributeButton = (Button) findViewById(com.uniparthenope.mysmartaquarium.R.id.add_attr_button);
        ...
        attributeData.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewAttrDataLabel);
                    label.setText(attributeData.getHint());
                    attributeData.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_selector));
                }
            }

            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewAttrDataMessage);
                label.setText("");
            }
