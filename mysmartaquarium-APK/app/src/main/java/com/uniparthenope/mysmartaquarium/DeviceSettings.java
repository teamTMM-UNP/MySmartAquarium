...
public class DeviceSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uniparthenope.mysmartaquarium.R.layout.activity_device_settings);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Toolbar toolbar = (Toolbar) findViewById(com.uniparthenope.mysmartaquarium.R.id.toolbar_Devices);
        if (toolbar != null) {
            toolbar.setTitle("");
        ...
        TextView main_title = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.devices_toolbar_title);
    ...
    void init() {
        ...
        currDeviceCheckBox = (CheckBox) findViewById(com.uniparthenope.mysmartaquarium.R.id.deviceTrustStateCheckBox);
    ...
    private void showTrustedDevices() {
        TextView currDeviceState = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.currDeviceState);
        ...
        devicesListView = (ListView) findViewById(com.uniparthenope.mysmartaquarium.R.id.listViewTrustedDevices);
