...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uniparthenope.mysmartaquarium.R.layout.activity_main);
        ...
        mDrawer = (DrawerLayout) findViewById(com.uniparthenope.mysmartaquarium.R.id.main_drawer_layout);
    ...
    private void performAction(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case com.uniparthenope.mysmartaquarium.R.id.nav_sign_up:
                // Start sign-up
                signUpNewUser();
                break;
            case com.uniparthenope.mysmartaquarium.R.id.nav_sign_up_confirm:
                // Confirm new user
                confirmUser();
                break;
            case com.uniparthenope.mysmartaquarium.R.id.nav_sign_in_forgot_password:
                // User has forgotten the password, start the process to set a new password
                forgotpasswordUser();
                break;
            case com.uniparthenope.mysmartaquarium.R.id.nav_about:
                // For the inquisitive
    ...
    private void signInUser() {
        ...
        if(username == null || username.length() < 1) {
            TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewUserIdMessage);
            label.setText(inUsername.getHint()+" cannot be empty");
            inUsername.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_error));
            return;
        }
        ...
        if(password == null || password.length() < 1) {
            TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewUserPasswordMessage);
            label.setText(inPassword.getHint()+" cannot be empty");
            inPassword.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_error));
            return;
        }
    ...
    private void continueWithFirstTimeSignIn() {
        ...
        try {
            ...
            label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewUserIdMessage);
            label.setText("Sign-in failed");
            inUsername.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_error));
    ...
    {
        Intent userActivity = new Intent(this, Acquari.class);
    ...
    private void initApp() {
        inUsername = (EditText) findViewById(com.uniparthenope.mysmartaquarium.R.id.editTextUserId);
        inUsername.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if(s.length() == 0) {
                    TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewUserIdLabel);
                    label.setText(com.uniparthenope.mysmartaquarium.R.string.Username);
                    inUsername.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_selector));
                }
            }
        ...
        inPassword = (EditText) findViewById(com.uniparthenope.mysmartaquarium.R.id.editTextUserPassword);
        inPassword.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if(s.length() == 0) {
                    TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewUserPasswordLabel);
                    label.setText(com.uniparthenope.mysmartaquarium.R.string.Password);
                    inPassword.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_selector));
                }
            }
