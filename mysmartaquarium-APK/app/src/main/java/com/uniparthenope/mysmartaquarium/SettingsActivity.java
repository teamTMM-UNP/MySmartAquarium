...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uniparthenope.mysmartaquarium.R.layout.activity_settings);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Toolbar toolbar = (Toolbar) findViewById(com.uniparthenope.mysmartaquarium.R.id.toolbar_settings);
        toolbar.setTitle("");
        ...
        TextView main_title = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.settings_toolbar_title);
    ...
    private void init()
    {
        ...
        smsSwitch = (Switch) findViewById(com.uniparthenope.mysmartaquarium.R.id.switchSettingsPhone);
