...
public class UserAttributesAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = layoutInflater.inflate(com.uniparthenope.mysmartaquarium.R.layout.fields_generic, null);
            holder = new Holder();
            holder.label = (TextView) convertView.findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewUserDetailLabel);
            holder.data = (TextView) convertView.findViewById(com.uniparthenope.mysmartaquarium.R.id.editTextUserDetailInput);
            holder.message = (TextView) convertView.findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewUserDetailMessage);
        ...
        if(item.getDataDrawable() != null) {
            if(item.getDataDrawable().equals("checked")) {
                resID = com.uniparthenope.mysmartaquarium.R.drawable.checked;
            }
            else if(item.getDataDrawable().equals("not_checked")) {
                resID = com.uniparthenope.mysmartaquarium.R.drawable.not_checked;
            }
        }
