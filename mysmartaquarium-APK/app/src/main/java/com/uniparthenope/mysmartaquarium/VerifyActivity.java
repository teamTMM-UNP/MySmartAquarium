...
public class VerifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uniparthenope.mysmartaquarium.R.layout.activity_verify);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Toolbar toolbar = (Toolbar) findViewById(com.uniparthenope.mysmartaquarium.R.id.toolbar_verify);
        toolbar.setTitle("");
        ...
        TextView main_title = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.verify_toolbar_title);
    ...
    private void init() {
        verifCode = (EditText) findViewById(com.uniparthenope.mysmartaquarium.R.id.editTextVerifyCode);
        reqPhoneVerf = (Button) findViewById(com.uniparthenope.mysmartaquarium.R.id.buttonVerifyPhone);
        reqEmailVerf = (Button) findViewById(com.uniparthenope.mysmartaquarium.R.id.buttonVerifyEmail);
        sendVerfCode = (Button) findViewById(com.uniparthenope.mysmartaquarium.R.id.buttonSendVerifyCode);

        if(AppHelper.isEmailAvailable()) {
            if(AppHelper.isEmailVerified()) {
                reqEmailVerf.setClickable(false);
                reqEmailVerf.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.button_success));
        ...
        if(AppHelper.isPhoneAvailable()) {
            if(AppHelper.isPhoneVerified()) {
                ...
                reqPhoneVerf.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.button_success));
    ...
    private void reqEmailCode() {
        attrReqCode = "email";
        reqEmailVerf.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.button_selected));
    ...
    private void reqPhoneCode() {
        ...
        reqPhoneVerf.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.button_selected));
    ...
    private void sendVerfCode() {
        ...
        if(code == null) {
            TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewVerifyCodeMessage);
            label.setText(verifCode.getHint()+" cannot be empty");
            verifCode.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_error));
            return;
        }
    ...
    private void showCodeTX() {
        ...
        verifCode.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewVerifyCodeLabel);
                    label.setText(verifCode.getHint());
                    verifCode.setBackground(getDrawable(com.uniparthenope.mysmartaquarium.R.drawable.text_border_selector));
                }
            }
