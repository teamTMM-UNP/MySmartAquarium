...
public class NewPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.uniparthenope.mysmartaquarium.R.layout.activity_new_password);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Toolbar toolbar = (Toolbar) findViewById(com.uniparthenope.mysmartaquarium.R.id.toolbar_NewPassword);
        if (toolbar != null) {
            toolbar.setTitle("");
        ...
        TextView main_title = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.newpassword_toolbar_title);
    ...
    private void init() {
        newPassword = (EditText) findViewById(com.uniparthenope.mysmartaquarium.R.id.editTextNewPassPass);
        newPassword.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (s.length() == 0) {
                    TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewNewPassPassLabel);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                TextView label = (TextView) findViewById(com.uniparthenope.mysmartaquarium.R.id.textViewNewPassPassMessage);
                label.setText("");
            }
        ...
        continueSignIn = (Button) findViewById(com.uniparthenope.mysmartaquarium.R.id.buttonNewPass);
    ...
    private void refreshItemsDisplayed() {
        ...
        displayListView = (ListView) findViewById(com.uniparthenope.mysmartaquarium.R.id.listViewCurrentUserDetails);
